  ...
  return (
    <div>
      ...
      <SU.Box>
        ...
        {edit ? (
          <><SU.LongInputStyle value={formData.userNickName || ''} onChange={e => handleChange('userNickName', e.target.value)} /></>
        ) : (
        ...
        {edit ? (
          <><SU.InputStyle value={formData.userPhone || ''} onChange={e => handleChange('userPhone', e.target.value)} />
           <SU.CheckDiv onClick={() => handleChange('userSnsOk', !formData.userSnsOk)}>
              <img src={formData.userSnsOk ? checkedUrl : uncheckedUrl} 
                alt="sms-agree" width={16} height={16} style={{ marginRight: '0.5rem' }}/>
                문자수신동의
            </SU.CheckDiv>
            <SU.NumEmailSpace />
            <SU.InputButtonDiv>
        ...
        {edit ? (
          <><SU.InputStyle value={formData.userEmail || ''} onChange={e => handleChange('userEmail', e.target.value)} />
            <SU.CheckDiv onClick={() => handleChange('userMailOk', !formData.userMailOk)}>
              <img src={formData.userMailOk ? checkedUrl : uncheckedUrl}
                alt="email-agree" width={16} height={16} style={{ marginRight: '0.5rem' }}/>
                이메일 수신동의
            </SU.CheckDiv>
            <SU.NumEmailSpace />
            <SU.InputButtonDiv>
      ...
      {emailVerified && (
        <>
          <SU.Box>
            ...
            <SU.LongInputStyle value={verificationCode} onChange={handleVerificationCodeChange} />
            <SU.ApproveSpace />
            {isVerified ? (
