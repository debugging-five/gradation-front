      ...
      <S.Chapter4>
        ...
        <S.Step>
          ...
          <S.TimelineContent>
            ...
            <S.TimelineText>
              신청 완료 후, 정해진 일정 맞춰 폐기된 미술품을 신청자분이 계신
              곳에 방문하여 수거합니다.
            </S.TimelineText>
            <S.TimelineText>
        ...
        <S.Step>
          ...
          <S.TimelineContent>
            ...
            <S.TimelineText>
              재사용 가능: 찢어진 캔버스 천, 액자 프레임, 일부 사용 된 채색
              도구, 팔레트
            </S.TimelineText>
            <S.TimelineText>
            ...
            <S.TimelineText>
              폐기 대상 : 납, 카드뮴이 포함된 물감, 스프레이 페인트,
              희석제(테레빈유, 시너), 접착제, 곰팡이 핀 종이나 캔버스
            </S.TimelineText>
          </S.TimelineContent>
        </S.Step>
        <S.Step>
          ...
          <S.TimelineContent>
            <S.TimelineTitle>
              가공 및 생산 - 새로운 제품 제작을 위한 변신
            </S.TimelineTitle>
            <S.TimelineText>
              캔버스 리폼 : 폐기된 캔버스를 세척, 보강하여 새로운 캔버스로 제작
            </S.TimelineText>
            <S.TimelineText>
              목제 프레임 재활용 : 낡은 액자를 컷팅, 샌딩 과정을 거쳐 재사용
              가능하게 가공
            </S.TimelineText>
            <S.TimelineText>
            ...
            <S.TimelineText>
              친환경 에코백 : 일부 오염된 캔버스를 제단하여 세척 후, 도색 및
              재단하여 가방으로 제작
            </S.TimelineText>
            <S.TimelineText>
